...
ax1.plot(xintg[:,0],400*np.ones((len(xintg[:,0],))),'--',color='orange')
ax1.plot(xintg[:,0],220*np.ones((len(xintg[:,0],))),'--',color='green')
...
ax31.plot(xintg[:,0],eofHypo2.T[:,4]+eofHypo.T[:,6]+np.mean(alllinesS,axis=0),color='orange')
...
ax32.plot(xintg[:,0],eofHypo2.T[:,44]+eofHypo.T[:,40]+np.mean(alllinesS,axis=0),color='green')
