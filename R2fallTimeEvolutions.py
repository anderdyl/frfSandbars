...
# for ii in range(len(time3)):
#     tempT = time3[ii].month
#     if tempT > 3 and tempT < 7:
#         binClass[ii] = 1
#     elif tempT >= 7 and tempT < 10:
#         binClass[ii] = 2
#     elif tempT >= 10 and tempT < 13:
#         binClass[ii] = 3
#     else:
#         binClass[ii] = 4
...
# for ii in range(len(time3)):
#     tempT = time3[ii].month
#     if tempT > 1 and tempT < 5:
#         binClass[ii] = 1
#     elif tempT >= 5 and tempT < 8:
#         binClass[ii] = 2
#     elif tempT >= 8 and tempT < 11:
#         binClass[ii] = 3
#     else:
#         binClass[ii] = 4
...
ax100.set_title('Migrations during falls')
